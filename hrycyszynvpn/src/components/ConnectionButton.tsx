...
export const ConnectionButton: React.FC<{
  ...
  const statusFillColor = getStatusFillColor(status);
  return (
    <ConnectSvg
      width="198"
      height="198"
    ...
    >
      <g filter="url(#filter0_f_89_61)">
        <circle cx="99" cy="99" r="49" fill={statusFillColor} fillOpacity="0.5" />
      </g>
      <g filter="url(#filter1_d_89_61)">
        <circle cx="99" cy="99" r="65" fill="url(#paint0_radial_89_61)" id="button_face" />
        <circle cx="99" cy="99" r="61.5" stroke={statusFillColor} strokeWidth="7" />
      </g>
...
const getStatusFillColor = (status: ConnectionStatusKind): string => {
  switch (status) {
...
const getStatusTextColor = (status: ConnectionStatusKind): string => {
  switch (status) {
    case ConnectionStatusKind.disconnected:
    case ConnectionStatusKind.connecting:
